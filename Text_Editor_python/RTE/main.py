...
class RTE(QMainWindow):
    ...
    def create_tool_bar(self):
        ...
        openAction = QAction(QIcon('images/save.png'), "Open file", self)
        ...
        self.fontBox.addItems(["Courier Std", "Hellentic Typewriter Regular", "Helvetica", "Arial", "SansSerif", "Helvetica", "Times", "Monospace","Arial Black","Batang","Bitstream Vera Sans","Brush Script MT", "Comic Sans MS", "GungSeo","Wingdings 3" , "Webdings" , "Tw Cen MT", "Symbol" , "MingLiU-ExtB"])
